        ...
        <div className="bg-white">
            <div className="mx-auto max-w-3xl px-4 py-16 sm:py-24 lg:px-8">
                ...
                <div className="mt-10 border-t border-zinc-200">
                    <div className="mt-10 flex flex-auto flex-col">
                        ...
                        <p className="mt-2 text-sm text-zinc-600">
                            We at PhoneCases believe that a phone case doesn't only need to look good but also last you for
                            the years to come. We offer a 5-year print guarantee: If you case isn't of the highest quality,
                            we'll replase it for free. 
                        </p>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="grid grid-cols-2 gap-x-6 border-t border-zonc-200 py-10 text-sm">
                        <div>
